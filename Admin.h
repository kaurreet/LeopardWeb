...
public:
	...
	//link and unlink instructor to course linking methods 
	string link_instructorCourse(int instructorID, int courseCRN);
	string unlink_instructorCourse(int instructorID, int courseCRN);
