...
Admin::Admin(string in_fname, string in_lname, int in_ID) : User(in_fname,in_lname, in_ID){
	first_name = in_fname;
	last_name = in_lname;
	ID = in_ID;
}
...
string Admin::link_instructorCourse(int instructorID, int courseCRN) {
	return "INSERT INTO COURSE_INSTRUCTOR (InstructorID, CRN) VALUES (" + std::to_string(instructorID) + ", " + std::to_string(courseCRN) + ");";
}

string Admin::unlink_instructorCourse(int instructorID, int courseCRN) {
	return "DELETE FROM COURSE_INSTRUCTOR WHERE InstructorID = " + std::to_string(instructorID) + " AND CRN = " + std::to_string(courseCRN) + ";"; 
}
//destructor
Admin::~Admin() {
